        ...
        try:
            while True:
                if gpio.input(self.pir_pin) == 1:
                    ...
                    pub.single("iot/pir", "pir:motion detected", hostname="172.30.1.51")
                else:
                    print("no motion")
                time.sleep(2)
...
class myDht(Thread):
    def __init__(self):
        super().__init__()
        self.mydht11 = adafruit_dht.DHT11(board.D20)
    ...
    def run(self):
        while True:
            try:
                ...
                print(temp, humid)
                #pub.single("iot/dht", "temp:"+str(temp) , hostname="172.30.1.51")
                #pub.single("iot/dht", "humid:"+str(humid), hostname="172.30.1.51")
                time.sleep(2)
        ...
        try:
            while True:
                ...
                if 2<dis_val<400:
                    ...
                    pub.single("iot/hc", "hc:distance "+str(dis_val), hostname="172.30.1.51")
                    time.sleep(2)
